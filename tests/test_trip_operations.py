...
def test_reservations_are_redacted_and_recheck_list_is_present():
    private_provenance = {**PROVENANCE, "source_url": "https://example.test/operations?token=private-token", "note": "guest 王小明"}
    ...
    for secret in ("ABCDEF1234", "family@example.test", "09012345678", "王小明", "A123456789", "private", "private-token"):
